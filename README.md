...
- O que vamos avaliar:
	...
	- Aplicação Back-end consiste em uma chamadas de usuários:
		...
		- Regras de Negócio
			...
			1. Preciso ver as chamadas da api nos diversos métodos (POST,GET,DELETE...)
			2. Além disso como você aplica as validações de chamadas de API.
